...
function Card({ width, start, para , hover="none" }) {
  return (
    <div className={`bg-zinc-800 p-5 rounded-xl hover:${hover} ${width} min-h-120  flex flex-col justify-between`}>
      ...
      <div className="down w-full">
        ...
        {para && (<p className="text-sm text-zinc-500 font-medium"></p>)}
      </div>
    </div>
  );
}
